...
async def restructure_avatar(request: AvatarRestructureRequest) -> dict:
    ...
    clean = request.sentence.lower().strip().replace("-", " ")
    for p in ".,?!;:":
        clean = clean.replace(p, "")

    # ── Demo Hardcoded Sentence 1: ENCIK, SAYA BOLEH TOLONG APA? ──
    if ("encik" in clean and "tolong" in clean and "apa" in clean) or clean == "encik saya boleh tolong apa":
        ...
        return {
            ...
            "tokens": ["encik", "saya", "boleh", "tolong", "apa"],
            "display": ["Encik", "Saya", "Boleh", "Tolong", "Apa"],
            "displayTokens": ["Encik", "Saya", "Boleh", "Tolong", "Apa"],
            "motionFile": "sentence_1_bim_encik_saya_boleh_tolong_apa.json",
            "candidates": [
                {
                ...
                },
                {
                    ...
                    "display": ["Encik", "Apa", "Yang", "Saya", "Boleh", "Tolong"],
    ...
    if ("hospital" in clean and ("kenapa" in clean or "datang" in clean or "awak" in clean or "apa khabar" in clean)) or "apa khabar hari ini awak datang hospital kenapa" in clean:
        await asyncio.sleep(0.65)
        return {
            "model": "Gonka Multi-Model Consensus (3 Models)",
            ...
            "tokens": ["apa_khabar", "hari_ini", "awak", "datang", "hospital", "kenapa"],
            "display": ["Apa-Khabar", "Hari-Ini", "Awak", "Datang", "Hospital", "Kenapa"],
            "displayTokens": ["Apa-Khabar", "Hari-Ini", "Awak", "Datang", "Hospital", "Kenapa"],
            "motionFile": "sentence_2_bim_apa_khabar_hari_ini_awak_datang_hospital_kenapa.json",
            "candidates": [
                {
                    "model": "DeepSeek-V4-Flash",
                    "tokens": ["apa_khabar", "hari_ini", "awak", "datang", "hospital", "kenapa"],
                ...
                },
                {
                    ...
                    "display": ["Apa-Khabar", "Kenapa", "Datang", "Hospital", "Hari-Ini"],
